...
Тестирование на проникновение позволяет ответить на вопрос, как кто-то со злым умыслом может вмешаться в сеть. Используя инструменты пентеста, «белые хакеры» и профессионалы в области безопасности могут на любом этапе разработки или развертывания исследовать сети и приложения на предмет недостатков и уязвимостей путем взлома системы.
...
![Описание изображения](/images/image26.png)м
...
В ходе лабораторной работы было последовательно продемонстрировано использование Metasploit в качестве инструмента для проведения тестирования на проникновение: выполнено сканирование целевой системы, выявлены уязвимые сервисы, проведён подбор учётных данных, после чего реализованы атаки с применением готовых эксплойтов. В результате удалось получить удалённый доступ к системе-жертве и подтвердить успешность эксплуатации. Работа показала полный цикл применения Metasploit — от разведки и анализа до эксплуатации и постэксплуатационной проверки, закрепив практические навыки автоматизации пентест-задач.
